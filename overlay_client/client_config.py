...
class DeveloperHelperConfig:
    ...
    obs_capture_friendly: Optional[bool] = None
    ...
    def from_payload(cls, payload: Dict[str, Any]) -> "DeveloperHelperConfig":
        ...
        return cls(
            ...
            obs_capture_friendly=_bool(payload.get("obs_capture_friendly"), None),
...
def load_initial_settings(settings_path: Path) -> InitialClientSettings:
    ...
    obs_capture_friendly = bool(data.get("obs_capture_friendly", defaults.obs_capture_friendly))
    ...
    return InitialClientSettings(
        ...
        obs_capture_friendly=obs_capture_friendly,
