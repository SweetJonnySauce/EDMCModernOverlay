...
| 3 | Interrupted before task generation | Fresh Step 3 generator context was interrupted by the user's stop request before it returned a proposal or wrote files. | On explicit resume, reconcile the handoff and start a new fresh Step 3 generator context. |
